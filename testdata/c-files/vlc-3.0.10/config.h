...
#define CONFIGURE_LINE "./configure  '--prefix=/testdata/vlc-build/'"
...
#define PACKAGE_STRING "vlc 3.0.10"
...
#define PACKAGE_VERSION_REVISION 10
...
#define VERSION_MESSAGE "3.0.10 Vetinari"

/* compiler */
#define VLC_COMPILER "gcc version 9.3.0 (GCC)"

/* user who ran configure */
#define VLC_COMPILE_BY "root"

/* host which ran configure */
#define VLC_COMPILE_HOST "fb957e0e2c3a"
