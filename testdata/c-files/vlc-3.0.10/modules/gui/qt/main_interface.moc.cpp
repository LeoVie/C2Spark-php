...
void MainInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MainInterface::*)(vout_window_t * , unsigned  , unsigned  , bool , bool * );
        ...
        {
            using _t = void (MainInterface::*)(unsigned int , unsigned int );
        ...
        {
            using _t = void (MainInterface::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainInterface::askHideMouse)) {
                *result = 4;
                return;
            }
        }
