...
void ActionsManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ActionsManager::*)(vlc_renderer_item_t * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ActionsManager::rendererItemAdded)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ActionsManager::*)(vlc_renderer_item_t * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ActionsManager::rendererItemRemoved)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ActionsManager::staticMetaObject = {
